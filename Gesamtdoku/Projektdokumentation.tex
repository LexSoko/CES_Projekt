...
\date{}
\author{Max Jost, Martin Steiner}
...
\begin{document}
    ...
    %     \input{chapters/Physikalisches_Systems.tex}
    %     \input{chapters/Hardware.tex}
    %     \input{chapters/Mechanik.tex}
    %     \input{chapters/Sensoren_Aktoren.tex}
    %     \input{chapters/Messablauf.tex}
    %     \input{chapters/Messschleife.tex}
    %     \input{chapters/Code.tex}
    %     \input{chapters/Messdaten.tex}
